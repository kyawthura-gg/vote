<x-app-layout>
    <div>
        <a href="/" class="flex items-center font-semibold hover:underline">
            <svg class="w-4 h-4" xmlns="http://www.w3.org/2000/svg" class="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        ...
        <div class="flex flex-1 px-4 py-6">
            ...
            <div class="w-full mx-4">
                ...
                <div class="mt-3 text-gray-600">
                    Lorem ipsum dolor sit. Lorem ipsum dolor sit amet consectetur adipisicing elit. Sint ea tempora aliquam aperiam expedita. Nesciunt, suscipit, a commodi neque sequi facere iure perspiciatis quasi velit sed eligendi quia. Aliquam, sunt!
                </div>
    ...
    <div class="flex items-center justify-between mt-6 button-container">
        <div class="flex items-center ml-6 space-x-4">
            <div class="relative">
                <button type="button" class="flex items-center justify-center w-32 px-6 py-3 text-sm font-semibold text-white transition duration-150 ease-in border h-11 bg-blue rounded-xl border-blue hover:bg-blue-hover">
                    Reply
                </button>
                <div class="absolute z-10 hidden mt-2 text-sm font-semibold text-left bg-white w-104 shadow-dialog rounded-xl">
                    <form action="#" class="px-4 py-6 space-y-4">
                        ...
                        <div class="flex items-center space-x-3">
                            ...
                            <button type="button" class="flex items-center justify-center w-1/2 px-6 py-3 text-sm font-semibold text-white transition duration-150 ease-in border h-11 bg-blue rounded-xl border-blue hover:bg-blue-hover">
                                Post Comment
                            </button>
            ...
            <div class="relative">
                <button type="button" class="flex items-center justify-center px-6 py-3 text-sm font-semibold transition duration-150 ease-in bg-gray-200 border border-gray-200 w-36 h-11 rounded-xl hover:border-gray-400">
                    <span>Set Status</span>
                    <svg class="w-4 h-4 ml-2" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7" />
                    </svg>
                </button>
                <div class="absolute z-10 mt-2 text-sm font-semibold text-left bg-white w-76 shadow-dialog rounded-xl">
                    <form action="#" class="px-4 py-6 space-y-4">
