        ...
        <div class="w-70 mr-5">
            <div class="bg-white border-2 border-blue rounded-xl mt-16" style="
                ...
                <form action="#" method="POST" class="space-y-4 px-4 py-6">
                    ...
                    <div>
                        <textarea name="idea" id="idea" cols="30" rows="4" class="w-full text-sm bg-gray-100 rounded-xl border-none placeholder-gray-900 px-4 py-2" placeholder="Describe your idea"></textarea>
                    </div>
