<div class="idea-and-button">
            ...
            <div class="w-full mx-2 md:mx-4">
                ...
                <div class="flex flex-col justify-between mt-6 md:flex-row md:items-center">
                    ...
                    <div class="flex items-center mt-4 md:hidden md:mt-0">
                        ...
                        @if ($hasVoted)
                        <button class="w-20 px-4 py-3 -mx-5 font-bold text-white uppercase transition duration-150 ease-in border bg-blue border-blue text-xxs rounded-xl hover:bg-blue-hover">
                            Voted
                        </button>
                        @else
    ...
    <div class="flex items-center justify-between mt-6 buttons-container">
        ...
        <div class="items-center hidden space-x-3 md:flex">
            ...
            @if ($hasVoted)
            <button type="button" class="w-32 px-6 py-3 text-xs font-semibold text-white uppercase transition duration-150 ease-in border h-11 bg-blue rounded-xl border-blue hover:bg-blue-hover">
                <span>Voted</span>
            </button>
            @else
